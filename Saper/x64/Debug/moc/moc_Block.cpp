...
QT_MOC_LITERAL(1, 6, 12), // "rightClicked"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "leftClicked"
QT_MOC_LITERAL(4, 32, 15), // "mousePressEvent"
QT_MOC_LITERAL(5, 48, 12), // "QMouseEvent*"
QT_MOC_LITERAL(6, 61, 1) // "e"

    },
    "Block\0rightClicked\0\0leftClicked\0"
...
void Block::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Block::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Block::rightClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Block::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Block::leftClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Block::rightClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Block::leftClicked()
{
